...
var file_notification_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0x27, 0x0a, 0x13, 0x4e, 0x6f, 0x74, 0x69,
	...
	0x6d, 0x22, 0x2d, 0x0a, 0x11, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f,
	...
	0x12, 0x17, 0x2e, 0x70, 0x62, 0x2e, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69,
	0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x70, 0x62, 0x2e, 0x4e,
...
var file_notification_proto_goTypes = []interface{}{
	...
	(*NotificationReply)(nil),   // 1: pb.NotificationReply
}
var file_notification_proto_depIdxs = []int32{
	0, // 0: pb.Notification.Notification:input_type -> pb.NotificationRequest
	1, // 1: pb.Notification.Notification:output_type -> pb.NotificationReply
...
func (c *notificationClient) Notification(ctx context.Context, in *NotificationRequest, opts ...grpc.CallOption) (Notification_NotificationClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Notification_serviceDesc.Streams[0], "/pb.Notification/Notification", opts...)
	if err != nil {
		return nil, err
	}
